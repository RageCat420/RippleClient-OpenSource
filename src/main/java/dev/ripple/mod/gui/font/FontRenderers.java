package dev.ripple.mod.gui.font;
...
public class FontRenderers {
    ...
    public static @NotNull RendererFontAdapter createDefault(float size, String name) throws IOException, FontFormatException {
        return new RendererFontAdapter(Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(FontRenderers.class.getClassLoader().getResourceAsStream("assets/ripple-client/font/" + name + ".ttf"))).deriveFont(Font.PLAIN, size), size);
    }
