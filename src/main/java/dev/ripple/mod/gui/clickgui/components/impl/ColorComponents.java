...
public class ColorComponents extends Component {
    ...
    public ColorComponents(UITab parent, ColorSetting setting) {
        super();
        this.parent = parent;
    ...
    public void update(int offset, double mouseX, double mouseY) {
        ...
        if ((UIScreen.clicked || UIScreen.hoverClicked) && isVisible()) {
            if (!clicked) {
    ...
    public boolean draw(int offset, DrawContext drawContext, float partialTicks, Color color, boolean back) {
        ...
        if (colorSetting.injectBoolean) {
            ...
            switch (UI.INSTANCE.uiType.getValue()) {
                ...
                case New -> {
                    if (unShift) {
                        TextUtil.drawString(drawContext, colorSetting.getName(), x + 4, y + getTextOffsetY(), colorSetting.booleanValue ? UI.INSTANCE.enableTextS.getValue() : UI.INSTANCE.disableText.getValue());
                    }
                }
            }
        } else if (unShift) {
