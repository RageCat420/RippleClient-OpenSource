...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(Ripple.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = Ripple.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = Ripple.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
