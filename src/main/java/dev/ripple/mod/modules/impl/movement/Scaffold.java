...
public class Scaffold extends Module {
    ...
    private final BooleanSetting render = add(new BooleanSetting("Render", false).setParent());
        ...
        if (render.getValue()) {
            ...
            if (pos != null) {
                ...
                if (lastVec3d == null) {
                    ...
                    lastVec3d = new Vec3d(AnimateUtil.animate(lastVec3d.getX(), cur.x, sliderSpeed.getValue()), AnimateUtil.animate(lastVec3d.getY(), cur.y, sliderSpeed.getValue()), AnimateUtil.animate(lastVec3d.getZ(), cur.z, sliderSpeed.getValue()));
                }
