...
import static dev.ripple.api.utils.entity.MovementUtil.directionSpeed;
...
public class Strafe
    ...
    public void onStrafe(MoveEvent event) {
        ...
        if (mc.player.isSneaking() || HoleSnap.INSTANCE.isOn() || Speed.INSTANCE.isOn() || mc.player.isFallFlying() || Ripple.PLAYER.insideBlock || mc.player.isInLava() || mc.player.isTouchingWater() || mc.player.getAbilities().flying)
            return;
