...
import dev.ripple.api.events.impl.BoatMoveEvent;
...
import dev.ripple.asm.accessors.IVec3d;
...
public class EntityControl extends Module {
    ...
    public void onBoat(BoatMoveEvent event) {
        ...
        if (mc.currentScreen instanceof ChatScreen || mc.currentScreen != null && UI.INSTANCE.isOff()) {
