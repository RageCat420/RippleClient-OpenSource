...
import dev.ripple.mod.modules.impl.combat.Aura;
import dev.ripple.mod.modules.impl.player.PacketEat;
...
public class AutoDupe extends Module {
    ...
    public void onUpdate() {
        ...
        switch (mode.getValue()) {
            ...
            case NPlusOne -> {
                BlockPos placePos = SpeedMine.getBreakPos();
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Summon -> {
                        ...
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                        Ripple.ROTATION.snapAt(Ripple.ROTATION.lastYaw, 89);
                        sendSequencedPacket(id -> new PlayerInteractItemC2SPacket(Hand.MAIN_HAND, id, Ripple.ROTATION.lastYaw, 89));
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                    }
                    case Tame -> {
                        ...
                        if (mc.player.hasVehicle()) {
                            ...
                            if (llama.isBaby()) {
                                ...
                                InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                                Ripple.ROTATION.lookAt(llama.getPos());
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            Ripple.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = Ripple.ROTATION.getRotation(pos.toCenterPos())[0];
