...
public class Blocker extends Module {
    ...
    private final BooleanSetting eatingPause = add(new BooleanSetting("EatingPause", true, () -> page.getValue() == Page.Check).setParent());
    private final BooleanSetting sameHand = add(new BooleanSetting("SameHand", true, () -> page.getValue() == Page.Check && eatingPause.isOpen()));
    ...
    public void onUpdate() {
        ...
        if ((eatingPause.getValue() && !sameHand.getValue() && mc.player.isUsingItem()) || (eatingPause.getValue() && sameHand.getValue() && mc.player.isUsingItem() && mc.player.getActiveHand() == Hand.MAIN_HAND)) return;
        placeProgress = 0;
    ...
    private void tryPlaceObsidian(BlockPos pos) {
        ...
        if (detectMining.getValue() && Ripple.BREAK.isMining(pos)) {
            return;
        }
