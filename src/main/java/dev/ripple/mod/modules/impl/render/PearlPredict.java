...
import dev.ripple.api.events.impl.EntitySpawnEvent;
        ...
        for (Entity entity : mc.world.getEntities()) {
            if (entity instanceof EnderPearlEntity pearl) {
                ...
                if (ent.getMainHandStack().getItem() == Items.ENDER_PEARL || ent.getOffHandStack().getItem() == Items.ENDER_PEARL) {
                    ...
                    calcTrajectory(ent.getYaw(mc.getRenderTickCounter().getTickDelta(true)), ent.getPitch(mc.getRenderTickCounter().getTickDelta(true)), new Vec3d(x,y,z), ent.getVelocity());
                }
            }
        }
