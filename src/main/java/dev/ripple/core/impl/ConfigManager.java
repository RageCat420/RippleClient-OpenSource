...
import dev.ripple.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public void loadSettings() {
		for (Module module : Ripple.MODULE.modules) {
			...
			module.setState(Ripple.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + Ripple.PREFIX);

			for (UITab tab : Ripple.GUI.tabs) {
				printwriter.println(tab.getTitle() + "_x:" + tab.getX());
				printwriter.println(tab.getTitle() + "_y:" + tab.getY());
			}
			printwriter.println("armor_x:" + Ripple.GUI.armorHud.getX());
			printwriter.println("armor_y:" + Ripple.GUI.armorHud.getY());
			...
			System.out.println("[" + Ripple.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + Ripple.NAME + "] Failed to load settings");
		}
	}
