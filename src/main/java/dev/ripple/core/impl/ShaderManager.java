...
import dev.ripple.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        dev.ripple.mod.modules.impl.render.Shader shaderChams = dev.ripple.mod.modules.impl.render.Shader.INSTANCE;
