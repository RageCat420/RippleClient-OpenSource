...
public abstract class MixinChatHud implements IChatHudHook {
    ...
    @Redirect(method = {"addVisibleMessage"},
            at = @At(value = "INVOKE", target = "Ljava/util/List;size()I", ordinal = 2, remap = false, args = ""))
    ...
    @Unique
    private final ArrayList<FadeUtils> messageTimestamps = new ArrayList<>();
    @Unique
    private float fadeTime = 150;
